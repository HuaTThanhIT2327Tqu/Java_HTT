...
public class Invoice {
    ...
    private List<InvoiceManagementPanel.InvoiceDetail> chiTiet;
    ...
    public List<InvoiceManagementPanel.InvoiceDetail> getChiTiet() { return chiTiet; }
    public double getTongTien() { return tongTien; }
    
    public void addChiTiet(InvoiceManagementPanel.InvoiceDetail detail) {
        chiTiet.add(detail);
